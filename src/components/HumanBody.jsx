...
const HumanBody = ({ onSeleccionCambio }) => {
            ...
            <div className="human-body">
                ...
                {popup.visible && (
                    <div className="popup-selector animated" style={{ left: popup.x, top: popup.y }}>
                        <div className="option muybien" onClick={() => seleccionarEstado('muybien')}>
                            <span>Muy Bien</span>
                        </div>
                        <div className="option bien" onClick={() => seleccionarEstado('bien')}>
                            <span>Bien</span>
                        </div>
                        <div className="option normal" onClick={() => seleccionarEstado('normal')}>
                            <span>Normal</span>
                        </div>
                        <div className="option mal" onClick={() => seleccionarEstado('mal')}>
                            <span>Mal</span>
                        </div>
                        <div className="option muymal" onClick={() => seleccionarEstado('muymal')}>
                            <span>Muy Mal</span>
                        </div>
